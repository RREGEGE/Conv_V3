    ...
    class Log
    {
        ...
        private static string GetLogDirectory(LogMsg.LogType eLogType)
        {
            if (eLogType == LogMsg.LogType.Exception)
                return ManagedFileInfo.ExceptionLogDirectory;
            else if (eLogType == LogMsg.LogType.RackMaster)
                return ManagedFileInfo.STKLogDirectory;
            else
                return ManagedFileInfo.LogDirectory;
        }
        ...
        {
            if (eLogType == LogMsg.LogType.Exception)
                return ManagedFileInfo.ExceptionLogFileName;
            else if (eLogType == LogMsg.LogType.RackMaster)
                return ManagedFileInfo.STKLogFileName;
            else
                return ManagedFileInfo.LogFileName;
        }
