    ...
    public partial class UserEqStatusSub : UserControl
    {
        ...
        private void Panel_Resize(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                // 라벨 폰트 사이즈 조절
                AdjustFontSize(lblConvName, initialFontSize_lblConvName, ratio);


                // 라벨 크기 및 위치 조절
                AdjustLabel(lblConvName, initialSize_____lblConvName, initialLocation_lblConvName, widthRatio, heightRatio);
        ...
        private void AdjustFontSize(System.Windows.Forms.Label label, float initialFontSize, float ratio)
        {
            ...
            float newFontSize = (initialFontSize * ratio)*1.1f;
