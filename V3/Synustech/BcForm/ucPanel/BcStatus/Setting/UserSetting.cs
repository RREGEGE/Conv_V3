...
namespace Synustech.ucPanel.BcStatus.Setting
{
    public partial class UserSetting : UserControl
    {
        ...
        private float initialFontSize_lblSettingName;
        private Size initialSize_____lblSettingName;
        private Point initialLocation_lblSettingName;
        ...
        public UserSetting()
        {
            ...
            initialFontSize_lblSettingName = lblSettingName.Font.Size;
            initialSize_____lblSettingName = lblSettingName.Size;
            initialLocation_lblSettingName = lblSettingName.Location;
        ...
        private void Panel_Resize(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                // 라벨 폰트 사이즈 조절
                AdjustFontSize(lblSettingName, initialFontSize_lblSettingName, ratio);


                // 라벨 크기 및 위치 조절
                AdjustLabel(lblSettingName, initialSize_____lblSettingName, initialLocation_lblSettingName, widthRatio, heightRatio);
        ...
        private void DataSet()
        {
            ...
            dgSetting.DataSource = dtMain;
            dgSetting.ColumnHeadersDefaultCellStyle.Font = new Font("Arial", 11);
        }
    }
}
