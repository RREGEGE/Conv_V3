...
namespace Synustech.ucPanel.BcMotion
{
    public partial class UserConvControl : UserControl
    {
        ...
        public void ApplyInching(int value)
        {
        ...
        private void Panel_Resize(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                // 라벨 폰트 사이즈 조절
                AdjustFontSize(lblConvControl, initialFontSize_lbl_ConvControl, ratio);
                AdjustFontSize1(btn_Forward, initialFontSize_btn_Forward, ratio);
                AdjustFontSize1(btn_Backward, initialFontSize_btn_Backward, ratio);
                AdjustFontSize1(btnTurnJogPos, initialFontSize_btnTurnJogPos, ratio);
                AdjustFontSize1(btnTurnJogNeg, initialFontSize_btnTurnJogNeg, ratio);
                AdjustFontSize1(btn_Inching, initialFontSize_btn_Inching, ratio);
                AdjustFontSize1(btnDegree, initialFontSize_btn_Degree, ratio);
                AdjustFontSize1(btn_POS1, initialFontSize_btn_POS_1, ratio);
                AdjustFontSize1(btn_POS2, initialFontSize_btn_POS_2, ratio);
                AdjustFontSize1(btn_POS3, initialFontSize_btn_POS_3, ratio);
                AdjustFontSize1(btn_POS4, initialFontSize_btn_POS_4, ratio);

                // 라벨 크기 및 위치 조절
                AdjustLabel(lblConvControl, initialSize_____lbl_ConvControl, initialLocation_lbl_ConvControl, widthRatio, heightRatio);
                AdjustButton(btn_Forward, initialFontSize_btn_Forward, initialLocation_btn_Forward, initialSize_____btn_Forward, ratio);
                AdjustButton(btn_Backward, initialFontSize_btn_Backward, initialLocation_btn_Backward, initialSize_____btn_Backward, ratio);
                AdjustButton(btnTurnJogPos, initialFontSize_btnTurnJogPos, initialLocation_btnTurnJogPos, initialSize_____btnTurnJogPos, ratio);
                AdjustButton(btnTurnJogNeg, initialFontSize_btnTurnJogNeg, initialLocation_btnTurnJogNeg, initialSize_____btnTurnJogNeg, ratio);
                AdjustButton(btn_Inching, initialFontSize_btn_Inching, initialLocation_btn_Inching, initialSize_____btn_Inching, ratio);
                AdjustButton(btnDegree, initialFontSize_btn_Degree, initialLocation_btn_Degree, initialSize_____btn_Degree, ratio);
                AdjustButton(btn_POS1, initialFontSize_btn_POS_1, initialLocation_btn_POS_1, initialSize_____btn_POS_1, ratio);
                AdjustButton(btn_POS2, initialFontSize_btn_POS_2, initialLocation_btn_POS_2, initialSize_____btn_POS_2, ratio);
                AdjustButton(btn_POS3, initialFontSize_btn_POS_3, initialLocation_btn_POS_3, initialSize_____btn_POS_3, ratio);
                AdjustButton(btn_POS4, initialFontSize_btn_POS_4, initialLocation_btn_POS_4, initialSize_____btn_POS_4, ratio);
