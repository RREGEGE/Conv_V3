...
namespace MovenCore
{
    static public class Registry
    {
        static public class RTX
        {
            ...
            {
                RegistryKey rkey = Microsoft.Win32.Registry.LocalMachine.OpenSubKey(@"SOFTWARE\IntervalZero\RTX64", false);
        ...
        static public class WMX
        {
            ...
            {
                RegistryKey rkey = Microsoft.Win32.Registry.LocalMachine.OpenSubKey(@"SOFTWARE\SoftServo\WMX3", false);
            ...
            {
                RegistryKey rkey = Microsoft.Win32.Registry.LocalMachine.OpenSubKey(@"SOFTWARE\SoftServo\WMX3\CCLink", false);
            ...
            {
                RegistryKey rkey = Microsoft.Win32.Registry.LocalMachine.OpenSubKey(@"SOFTWARE\SoftServo\WMX3\M4", false);
        ...
        static public class Service
        {
            ...
            {
                RegistryKey rkey = Microsoft.Win32.Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\" + ServiceName, false);
            ...
            {
                RegistryKey rkey = Microsoft.Win32.Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\" + ServiceName, true);
