...
{
    public partial class UserMotion : UserControl
    {
        DataTable dtMain;
        private float initialPanelWidth;
        private float initialPanelHeight;

        private float initialFontSize_lblMotionName;
        private Size initialSize_____lblMotionName;
        private Point initialLocation_lblMotionName;
        ...
        public UserMotion()
        {
            ...
            initialFontSize_lblMotionName = lblMotionName.Font.Size;
            initialSize_____lblMotionName = lblMotionName.Size;
            initialLocation_lblMotionName = lblMotionName.Location;
        ...
        private void Panel_Resize(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                // 라벨 폰트 사이즈 조절
                AdjustFontSize(lblMotionName, initialFontSize_lblMotionName, ratio);


                // 라벨 크기 및 위치 조절
                AdjustLabel(lblMotionName, initialSize_____lblMotionName, initialLocation_lblMotionName, widthRatio, heightRatio);
        ...
        private void DataSet()
        {
            ...
            dgMotion.DataSource = dtMain;
            dgMotion.ColumnHeadersDefaultCellStyle.Font = new Font("Arial", 11);
        }
    }
}
