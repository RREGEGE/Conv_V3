    ...
    public partial class UserAlarmHistory : UserControl
    {
        ...
        private void Panel_Resize(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                // 라벨 폰트 사이즈 조절
                AdjustFontSize(lblAlarmName, initialFontSize_lblAlarmName, ratio*0.8f);


                // 라벨 크기 및 위치 조절
                AdjustLabel(lblAlarmName, initialSize_____lblAlarmName, initialLocation_lblAlarmName, widthRatio, heightRatio);
