                        ...
                        case AutoStep.Step100_InMode_Check_CST_Load_Status: // 자재가 있고 앞 컨베이어에도 자재가 있는 경우 추가해야됨
                            {
                                ...
                                else if (beforeConv != null && !longCnvCSTDetected)
                                {
                        ...
                        case AutoStep.Step215_InMode_Move_CV_Slow:
                            {
                                ...
                                if (longCnvFoupDetect[0] == SensorOnOff.On && longCnvFoupDetect[1] == SensorOnOff.Off && longCnvFoupDetect[2] == SensorOnOff.On)
                                {
                                    if (nextConv != null)
                                    {
                        ...
                        case AutoStep.Step220_InMode_Run_Condition_Check:
                            {
                                ...
                                LCV_Inmode_CST_Check_Detect();
                                // 마지막 컨베이어가 아닌 경우
                                if (nextConv != null && longCnVCSTBoth)
                                {
                                    ...
                                    if (nextConv.mode == Mode.Auto && nextConv.type == "Turn")
                                    {
                                ...
                                // 마지막 컨베이어인 경우 정지
                                else if (nextConv == null && longCnVCSTBoth)
                                {
                        ...
                        case AutoStep.Step250_InMode_Move_CV_Rolling_Out:
                            {
                                ...
                                else if (!LCV_Inmode_LastFoup_Detect_Check())
                                {
                                    Thread.Sleep(100);
                                    StopConveyor();
                                    _stepStopWatch.Reset();
                        ...
                        case AutoStep.Step280_InMode_Alarm_Condition_280:
                            {
                                LCV_Inmode_CST_Check_Detect();
                                LCnV_CST_Empty_Detect();
                                if(longCnvCSTDetected && longCnvFoupDetect[2] == SensorOnOff.On)
                                {
                                    StartConveyor(initVelocity);
                                    CV_AutoStep = AutoStep.Step290_InMode_Alarm_Wait_290;
                                }
                                else if (longCnvFoupDetect[0] == SensorOnOff.On && longCnvFoupDetect[1] == SensorOnOff.On && longCnvFoupDetect[2] == SensorOnOff.Off)
                                {
                                    portDirection = LineDirection.Output;
                                    StartConveyor(initVelocity);
                                    portDirection = LineDirection.Input;
                                ...
                                else if(longCnVCSTBoth || !longCnvCSTDetected)
                                {
                                    CV_AutoStep = AutoStep.Step290_InMode_Alarm_Wait_290;
                                }
                            }
                        ...
                        case AutoStep.Step300_OutMode_Check_CST_Load_Status:
                            {
                                ...
                                else if(nextConv != null & !longCnvCSTDetected)
                                {
                        ...
                        case AutoStep.Step420_OutMode_Run_Condition_Check:
                            {
                                ...
                                if (beforeConv != null && longCnVCSTBoth)
                                {
                                    if (beforeConv.mode == Mode.Alarm)
                                    {
                                        StopConveyor();
                                ...
                                else if(beforeConv == null && longCnVCSTBoth)
                                {
                                    StopConveyor();
                                    _stepStopWatch.Reset();
                                    CV_AutoStep = AutoStep.Step900_Final_CV_Wait;
                        ...
                        case AutoStep.Step450_OutMode_Move_CV_Rolling_Out:
                            {
                                ...
                                else if (!LCV_Outmode_LastFoup_Detect_Check())
                                {
                                    Thread.Sleep(100);
                                    StopConveyor();
                                    _stepStopWatch.Reset();
                        ...
                        case AutoStep.Step480_OutMode_Alarm_Condition_480:
                            {
                                LCV_Outmode_CST_Check_Detect();
                                LCnV_CST_Empty_Detect();
                                if (longCnvCSTDetected && longCnvFoupDetect[0] == SensorOnOff.On)
                                {
                                    StartConveyor(initVelocity);
                                    CV_AutoStep = AutoStep.Step490_OutMode_Alarm_Wait_490;
                                }
                                else if (longCnvFoupDetect[0] == SensorOnOff.Off && longCnvFoupDetect[1] == SensorOnOff.On && longCnvFoupDetect[2] == SensorOnOff.On)
                                {
                                    portDirection = LineDirection.Input;
                                    StartConveyor(initVelocity);
                                    portDirection = LineDirection.Output;
